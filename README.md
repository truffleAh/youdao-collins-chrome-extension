# youdao-collins-chrome-extension-pro

<!-- [![build](https://api.travis-ci.org/truffleAh/youdao-collins-chrome-extension-pro.svg?branch=master)](https://travis-ci.org/truffleAh/youdao-collins-chrome-extension-pro) -->

查询英文单词的[柯林斯](https://www.collinsdictionary.com/)释义的chrome扩展应用。支持划词翻译，数据来源于有道词典。

<!-- ![intro](https://oyyd.github.io/youdao-collins-chrome-extension-pro/pics/intro.webp) -->
...
[issues](https://github.com/truffleAh/youdao-collins-chrome-extension/issues)
